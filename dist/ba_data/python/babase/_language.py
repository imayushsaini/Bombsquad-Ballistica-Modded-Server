...
class Lstr:
    ...
    **Example 4: Nesting**
    ...
    def __init__(self, *args: Any, **keywds: Any) -> None:
        ...
        if isinstance(self.args.get('value'), _babase.LangStr):
            self.args['value'] = self.args['value'].evaluate()
        elif hasattr(self.args.get('value'), 'evaluate') and not isinstance(
            self.args.get('value'), our_type
        ):
            self.args['value'] = self.args['value'].evaluate()
        ...
        if 'subs' in keywds:
            ...
            if subs is not None:
                for key, value in keywds['subs']:
                    ...
                    elif isinstance(value, _babase.LangStr):
                        subs_filtered.append((key, value.evaluate()))
    ...
    def as_json(self) -> str:
        ...
        return json.dumps(self.args, separators=(',', ':'), default=_default)
